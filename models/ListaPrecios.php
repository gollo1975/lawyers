 ...
 *
 * @property ReferenciaListaPrecio[] $referenciaListaPrecios
 */
class ListaPrecios extends \yii\db\ActiveRecord
{
     ...
     */
    public function getReferenciaListaPrecios()
    {
        return $this->hasMany(ReferenciaListaPrecio::className(), ['id_lista' => 'id_lista']);
    }
}
