        ...
        <div class="table table-responsive">
            <div class="panel panel-primary ">
                <div class="panel-heading" style="text-align: left ">
                  Observacion del precio de venta
                </div>
                <div class="panel-body">
                    
                    <div class="row">
                        <?= $form->field($model, 'nota', ['template' => '{label}<div class="col-sm-8 form-group">{input}{error}</div>'])->textarea(['rows' => 6, 'onKeyUp' => 'maximo(this, 200)', 'onKeyDown' => 'maximo(this, 200)']) ?>
