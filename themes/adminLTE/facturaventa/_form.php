...
<?php $form = ActiveForm::begin([
 ...
 <div class="panel panel-success">
    ...
    <div class="panel-body">
        ...
        $( "#'.Html::getInputId($model, 'nro_demanda',['required', 'class' => 'select-2']).'" ).html( data ); });']); ?>
        </div>
        <div class="row">            
            <?= $form->field($model, 'nro_demanda')->widget(Select2::classname(), [
            'data' => $demandas,
         ...
         <div class="row">                        
            <?= $form->field($model, 'tipo_factura')->widget(Select2::classname(), [
            'data' => $tipo_factura,
            'options' => ['placeholder' => 'Seleccione una orden de producción...'],
            'pluginOptions' => [
                'allowClear' => true
        ...
        <div class="row">
          ...
          <div class="row" style="text-align: right">  
              <?php if($config->id_tipo_regimen == 1){?>
                 <?= $form->field($model, 'aplica_iva')->checkBox(['checked' => 'true','label' => 'aplica_iva',''=>'small', 'class'=>'bs_switch','style'=>'margin-bottom:5px;', 'id'=>'aplica_iva']) ?> 
              <?php }else{?>
                 <?= $form->field($model, 'aplica_iva')->checkBox(['label' => 'aplica_iva',''=>'small', 'class'=>'bs_switch','style'=>'margin-bottom:5px;', 'id'=>'aplica_iva']) ?> 
              <?php }?>
        </div>    
