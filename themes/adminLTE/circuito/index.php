...
<div class="circuito-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            [                
                'attribute' => 'id_circuito',
                'contentOptions' => ['class' => 'col-lg-2'],
            ],
            [                
                'attribute' => 'nombre_circuito',
                'contentOptions' => ['class' => 'col-lg-6'],                
            ],
            [               
                 'attribute' => 'estado_circuito',
                'value' => function($model) {
                    $estado = \app\models\Circuito::findOne($model->id_circuito);
                    return $estado->activo;
                },
                'filter' => ArrayHelper::map(\app\models\Circuito::find()->all(), 'estado_circuito', 'activo'),        
