        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                     ...
                     <?= $form->field($model, 'observacion', ['template' => '{label}<div class="col-sm-4 form-group">{input}{error}</div>'])->textarea(['rows' => 5, 'maxlength' => true, 'size' => 200]) ?>
                </div>
