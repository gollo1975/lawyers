 ...
 <div class="panel panel-success">
    <div class="panel-heading">
     ...
     <div class="panel-body">
         ...
         <div class="row">
             <?= $form->field($model, 'vista_cliente')->dropDownList(['0' => 'NO', '1' => 'SI'], ['prompt' => 'Seleccione una opcion...']) ?>
         </div> 
          <div class="row">
             <?= $form->field($model, 'vista_abogados')->dropDownList(['0' => 'NO', '1' => 'SI'], ['prompt' => 'Seleccione una opcion...']) ?>
         </div>
         <div class="row">
             <?= $form->field($model, 'vista_demandados')->dropDownList(['0' => 'NO', '1' => 'SI'], ['prompt' => 'Seleccione una opcion...']) ?>
         </div>
