        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-5 form-group">
                    <?= Html::textInput('descripcion', '', ['id' => 'descripcion', 'aria-required' => true, 'aria-invalid' => 'false', 'maxlength' => 120, 'class' => 'form-control', 'placeholder' => 'Solo se admiten archivos con extension pdf, docx y txt.', 'style' => 'width:65%', 'required' => true]) ?>                        
                </div>   
            </div>                
            <div class="row">
