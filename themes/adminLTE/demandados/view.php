...
$this->title = 'Detalle demandado';
$this->params['breadcrumbs'][] = ['label' => 'Demandado', 'url' => ['index']];
    ...
    <div class="panel-body">
        <table class="table table-bordered">
            ...
            <tr style="font-size: 85%;">
                ...
                <td colspan="5"><?= $table->municipio->municipio ?></td>
            </tr>
            <tr style="font-size: 85%;">
