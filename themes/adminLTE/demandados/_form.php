...
$tipodocumento = ArrayHelper::map(TipoDocumento::find()->where(['=','vista_demandados', 1])->all(), 'id_tipo_documento', 'descripcion');
?>
<div class="panel panel-success">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            <?= $form->field($model, 'direccion_demandado')->input("text") ?>
            <?= $form->field($model, 'telefono_demandado')->input("text") ?>
        </div>
         <div class="row">
            <?php if($token == 0){?> 
        ...
        <div class="row">
            <?= $form->field($model, 'email_demandado')->input("text") ?>
        </div>
        <div class="row">
    ...
    <div class="panel-footer text-right">
        <a href="<?= Url::toRoute("demandados/index") ?>" class="btn btn-primary btn-sm"><span class='glyphicon glyphicon-circle-arrow-left'></span> Regresar</a>
