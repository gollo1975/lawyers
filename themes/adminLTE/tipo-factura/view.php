...
$this->params['breadcrumbs'][] = $model->tipo_factura;
?>
<div class="tipo-factura-view">
    ...
    <p>
        <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Regresar', ['index', 'id' => $model->tipo_factura], ['class' => 'btn btn-primary btn-sm']) ?>
		<?= Html::a('<span class="glyphicon glyphicon-pencil"></span> Editar', ['update', 'id' => $model->tipo_factura], ['class' => 'btn btn-success btn-sm']) ?>
        <?= Html::a('<span class="glyphicon glyphicon-trash"></span> Eliminar', ['delete', 'id' => $model->tipo_factura], [
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped table-hover">
                <tr style='font-size: 85%;'>
                    ...
                    <td><?= Html::encode($model->tipo_factura) ?></td>
                    ...
                    <td><?= Html::encode($model->porcentaje_retencion) ?></td>                    
                </tr>                
            </table>
        </div>
    </div>
            ...
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= Url::toRoute(["tipo-factura/editardetalle", "id_factura_venta_tipo_cuenta" => $val->id_factura_venta_tipo_cuenta, 'id' => $val->tipo_factura]) ?>" ><span class="glyphicon glyphicon-pencil"></span></a>
                        </td>
                ...
                <div class="panel-footer text-right">
                    <?= Html::a('<span class="glyphicon glyphicon-plus"></span> Nuevo', ['tipo-factura/nuevodetalles', 'id_factura_venta_tipo' => $model->tipo_factura], ['class' => 'btn btn-success btn-sm']) ?>                    
