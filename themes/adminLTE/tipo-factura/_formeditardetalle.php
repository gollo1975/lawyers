...
<div class="panel panel-success">
    ...
    <div class="panel-body">        
        ...
        <div class="panel-footer text-right">                        
            <a href="<?= Url::toRoute(["tipo-factura/view", 'id_factura_venta_tipo' => $facturaventatipocuenta->id_factura_venta_tipo_cuenta, 'id' => $facturaventatipocuenta->tipo_factura ]) ?>" class="btn btn-primary"><span class='glyphicon glyphicon-circle-arrow-left'></span> Regresar</a>
