...
$tipodocumento = ArrayHelper::map(TipoDocumento::find()->where(['=','vista_abogados', 1])->all(), 'id_tipo_documento', 'descripcion');
?>
<div class="panel panel-success">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <?php }else{?>
                ...
                'pluginOptions' => [
                  ...
                  <?= $form->field($model, 'documento')->input("text", ['readonly' => 'false']) ?>
            <?php } ?>
        </div>														   
        ...
        <div class="row">
            <?= $form->field($model, 'direccion_abogado')->input("text") ?>
            <?= $form->field($model, 'telefono_abogado')->input("text") ?>
        </div>
        <div class="row">
            <?= $form->field($model, 'email_abogado')->input("text") ?>
            <?= $form->field($model, 'tarjeta_profesional')->input("text") ?>
        </div>
         <div class="row">
            <?php if($token == 0){?> 
    ...
    <div class="panel-footer text-right">
        <a href="<?= Url::toRoute("abogados/index") ?>" class="btn btn-primary btn-sm"><span class='glyphicon glyphicon-circle-arrow-left'></span> Regresar</a>
